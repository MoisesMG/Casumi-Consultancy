<div class="custom-cpt icon-box-cpt">
    <?php 
    if( get_sub_field('icon_icon_box') ): 
        $icon = get_sub_field('icon_icon_box');
    ?>
        <img class="icon-icon-box" src="<?php echo esc_url( $icon['url'] ); ?>" alt="<?php echo esc_attr( $icon['alt'] ); ?>">
    <?php endif; ?>

    <?php if( get_sub_field('heading_icon_box') ): ?>
        <h3 class="heading-icon-box"><?php the_sub_field('heading_icon_box'); ?></h3>
    <?php endif; ?>
